...
export default function OnboardingOne({ navigation }) {
    const handleContinue = () => {
        navigation.push('OnboardingTwo')
    }

    return (
        <ImageBackground source={require('../../assets/onboarding1.jpeg')} style={styles.backgroundImage}>
            <View style={styles.screenContainer}>
                <Text style={styles.skip}>Skip</Text>
                <View style={styles.containerBoard}>
                    <View style={styles.boardText}>
                        <Text style={styles.h1Text}>One-Stop App</Text>
                        <Text style={styles.pText}>Get your meals from your fave restaurants, eateries with SwiftShop today.</Text>
                    </View>
