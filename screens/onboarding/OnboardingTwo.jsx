...
export default function OnboardingOne({ navigation }) {
    ...
    return (
        <ImageBackground source={require('../../assets/onboarding2.jpeg')} style={styles.backgroundImage}>
            <View style={styles.screenContainer}>
                <Text style={styles.skip}>Skip</Text>
                <View style={styles.containerBoard}>
                    <View style={styles.boardText}>
                        <Text style={styles.h1Text}>Swift & Sleek</Text>
                        <Text style={styles.pText}>Few minutes and you have received your order from us. Click Swift, Order Swift.</Text>
                    </View>
